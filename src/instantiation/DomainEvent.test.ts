...
describe('DomainEvent', () => {
  it('should be able to represent an event', () => {
    ...
    class OrderPlacedEvent
      extends DomainEvent<OrderPlacedEvent>
      implements OrderPlacedEvent {}
    const event = new OrderPlacedEvent({
      orderUuid: '__ORDER_UUID__',
      customerUuid: '__CUSTOMER_UUID__',
      occurredAt: '__TIMESTAMP__',
    });
  ...
  it('should be spreadable', () => {
    ...
    const differentEvent = new OrderPlacedEvent({
      ...event,
      orderUuid: '__DIFFERENT_ORDER_UUID__',
    });
